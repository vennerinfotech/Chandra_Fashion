...
@section('content')
    ...
    <div class="text-center my-5">
        <img src="{{ asset('uploads/products/download.jpeg') }}" alt="Contact Icon"
            class="rounded-circle mb-3" style="width:80px; height:80px;">
        <h2 class="fw-bold">Contact Us</h2>
        <p class="text-muted">
            Get in touch with our team. We're here to help with all your fashion and textile needs.
        </p>
    </div>
    ...
    <div class="container my-5">
        <div class="row g-4">
                ...
                <div class="card shadow-sm p-4">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message" rows="4" class="form-control" placeholder="Tell us about your requirements..." required></textarea>
                        </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm p-4 mb-3">
                    ...
                    <p class="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16"><path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/></svg>
                        <b>Office Address:</b> 123 Fashion District Mumbai,<br>Maharashtra 400001 India
                    </p>
                    ...
                    <p class="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16"><path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z"/></svg>
                        <b>Email:</b><br>
                        info@chandrafashion.com<br>
                        sales@chandrafashion.com
                    </p>
                ...
                <div class="card shadow-sm p-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="#" class="btn btn-sm btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16"><path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/></svg></a>
        ...
        <div class="mt-5">
            ...
            <p class="text-center">Visit our showroom and manufacturing facility</p>
