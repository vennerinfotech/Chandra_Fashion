                    ...
                    <tbody>
                        @foreach ($subscriptions as $index => $subscription)
                            <tr>
                                ...
                                <td>
                                    <!-- View Button -->
                                    <a href="{{ route('admin.newsletters.show', $subscription->id) }}" class="btn-action btn-sm" title="View">
                                        <i class="fa fa-eye"></i>
                                    </a>

                                    <!-- Delete Form -->
                                    <form action="{{ route('admin.newsletters.destroy', $subscription->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
