...
@section('content')
    <section class="breadcrumb-wrapper top-section-padding">
        ...
        <h2 class="breadcrumb-title">{{ $about->about_title ?? 'About Us' }}</h2>
    </section>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="position-relative about-img">
                        <img src="{{ asset($about->hero_image ?? 'images/hero-banner.png') }}" alt="Model" class="img-fluid w-100">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="position-relative about-img">
                        ...
                        <img src="{{ asset($firstTeamImage ?? 'images/product2.jpg') }}" alt="Model" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
                ...
                @foreach($about->stats ?? [] as $s)
                    <div class="stat-box">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="stat-number" data-count="{{ $s['number'] }}">{{ $s['number'] }}</div><span>{{ $s['suffix'] }}</span>
                        </div>
                ...
                @foreach($about->team ?? [] as $member)
                    <div class="col-md-6 col-lg-3">
                        <div class="team-leader-card">
                            <img src="{{ asset($member['image'] ?? 'images/team.png') }}" alt="{{ $member['name'] }}" class="leader-photo">
